...
#define AIO_USERNAME    "naveen1000"
#define AIO_KEY         "935bf537f26444ffb0e3a7990427ad55"
...
void setup()
{
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("realme XT", "naveen1000");
  WiFiMulti.addAP("Lenovo K50a40", "naveen1000");
 ...
 str = " Ask Google assistant to display msg!   ";
}
